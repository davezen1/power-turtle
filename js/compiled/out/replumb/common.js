...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var strings = (function (){var G__38333 = cljs.core.keep.call(null,cljs.core.identity,replumb.common.error_seq.call(null,err));
var G__38333__$1 = (cljs.core.truth_(exclude_error_msg_QMARK_)?cljs.core.filter.call(null,((function (G__38333){
return (function (p1__38329_SHARP_){
return cljs.core.not_EQ_.call(null,"ERROR",p1__38329_SHARP_.message);
});})(G__38333))
,G__38333):G__38333);
var G__38333__$2 = cljs.core.map.call(null,((function (G__38333,G__38333__$1){
return (function (p1__38330_SHARP_){
return p1__38330_SHARP_.message;
});})(G__38333,G__38333__$1))
,G__38333__$1)
;
return cljs.core.filter.call(null,cljs.core.complement.call(null,cljs.core.empty_QMARK_),G__38333__$2);
...
var G__38338 = new cljs.core.Keyword(null,"warning","warning",-1685650671).cljs$core$IFn$_invoke$arity$1(result);
if((G__38338 == null)){
return null;
} else {
return replumb.common.valid_eval_warning_QMARK_.call(null,G__38338);
}
});
/**
...
var new_fn_entries = cljs.core.map.call(null,(function (p1__38339_SHARP_){
return cljs.core.assoc.call(null,p1__38339_SHARP_,(1),"<hidden function>");
}),cljs.core.filter.call(null,(function (p1__38340_SHARP_){
return cljs.core.re_find.call(null,/-fn/,cljs.core.name.call(null,cljs.core.first.call(null,p1__38340_SHARP_)));
...
var len__29308__auto___38342 = arguments.length;
var i__29309__auto___38343 = (0);
while(true){
if((i__29309__auto___38343 < len__29308__auto___38342)){
args__29315__auto__.push((arguments[i__29309__auto___38343]));

var G__38344 = (i__29309__auto___38343 + (1));
i__29309__auto___38343 = G__38344;
continue;
} else {
}
break;
...
replumb.common.debug_prn.cljs$lang$applyTo = (function (seq38341){
return replumb.common.debug_prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq38341));
});
...
//# sourceMappingURL=common.js.map?rel=1509738665558
