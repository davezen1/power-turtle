...
return new cljs.core.Keyword(null,"evaluate","evaluate",1525218437).cljs$core$IFn$_invoke$arity$1(power_turtle.replumb_proxy.eval_opts.call(null,power_turtle.view.repl.replumb_opts)).call(null,(function (p1__39743_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-eval-complete","on-eval-complete",436163213),power_turtle.view.repl.console_key,p1__39743_SHARP_], null));
}),s);
});
goog.exportSymbol('power_turtle.view.repl.exec', power_turtle.view.repl.exec);

//# sourceMappingURL=repl.js.map?rel=1509738668045
