...
power_turtle.view.navigation.languages = cljs.core.PersistentHashMap.fromArrays(["en","pt_PT","zh_CN","id","zh_TW","fr","de","ru","es","ko","ta"],["English","Portugu\u00EAs","\u7C21\u9AD4\u4E2D\u6587","Bahasa Indonesia","\u4E2D\u570B\u50B3\u7D71\u7684","Fran\u00E7ais","Deutsche","\u0420\u0443\u0441\u0441\u043A\u0438\u0439","Espa\u00F1ol","\uD55C\uAD6D\uC5B4","\u0BA4\u0BAE\u0BBF\u0BB4\u0BCD"]);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [soda_ash.core.MenuMenu,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"position","position",-2011731912),"right"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [soda_ash.core.MenuItem,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [soda_ash.core.Dropdown,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"fluid","fluid",-1823657759),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.Keyword(null,"default-value","default-value",232220170),new cljs.core.Keyword(null,"labeled","labeled",1871152938),new cljs.core.Keyword(null,"floating","floating",-1978091029),new cljs.core.Keyword(null,"icon","icon",1679606541),new cljs.core.Keyword(null,"class-name","class-name",945142584),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"on-change","on-change",-732046149)],[true,"select language",true,"en",true,true,"world","icon",cljs.core.clj__GT_js.call(null,(function (){var iter__28947__auto__ = (function power_turtle$view$navigation$language_selector_$_a_language_selector_$_iter__41218(s__41219){
return (new cljs.core.LazySeq(null,(function (){
var s__41219__$1 = s__41219;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__41219__$1);
if(temp__4657__auto__){
var s__41219__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__41219__$2)){
var c__28945__auto__ = cljs.core.chunk_first.call(null,s__41219__$2);
var size__28946__auto__ = cljs.core.count.call(null,c__28945__auto__);
var b__41221 = cljs.core.chunk_buffer.call(null,size__28946__auto__);
if((function (){var i__41220 = (0);
while(true){
if((i__41220 < size__28946__auto__)){
var vec__41222 = cljs.core._nth.call(null,c__28945__auto__,i__41220);
var lang_code = cljs.core.nth.call(null,vec__41222,(0),null);
var lang_name = cljs.core.nth.call(null,vec__41222,(1),null);
cljs.core.chunk_append.call(null,b__41221,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),lang_code,new cljs.core.Keyword(null,"text","text",-1790561697),lang_name,new cljs.core.Keyword(null,"value","value",305978217),lang_code], null));

var G__41228 = (i__41220 + (1));
i__41220 = G__41228;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41221),power_turtle$view$navigation$language_selector_$_a_language_selector_$_iter__41218.call(null,cljs.core.chunk_rest.call(null,s__41219__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41221),null);
}
} else {
var vec__41225 = cljs.core.first.call(null,s__41219__$2);
var lang_code = cljs.core.nth.call(null,vec__41225,(0),null);
var lang_name = cljs.core.nth.call(null,vec__41225,(1),null);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),lang_code,new cljs.core.Keyword(null,"text","text",-1790561697),lang_name,new cljs.core.Keyword(null,"value","value",305978217),lang_code], null),power_turtle$view$navigation$language_selector_$_a_language_selector_$_iter__41218.call(null,cljs.core.rest.call(null,s__41219__$2)));
}
} else {
return null;
}
...
return iter__28947__auto__.call(null,cljs.core.sort_by.call(null,cljs.core.key,power_turtle.view.navigation.languages));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41232),power_turtle$view$navigation$menu_bar_$_iter__41229.call(null,cljs.core.chunk_rest.call(null,s__41230__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41232),null);
}
} else {
var link = cljs.core.first.call(null,s__41230__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [soda_ash.core.MenuItem,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"as","as",1148689641),"a",new cljs.core.Keyword(null,"href","href",-793805698),["#",cljs.core.str.cljs$core$IFn$_invoke$arity$1(link)].join(''),new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.call(null,cljs.core.deref.call(null,route),link)], null),link], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),link], null)),power_turtle$view$navigation$menu_bar_$_iter__41229.call(null,cljs.core.rest.call(null,s__41230__$2)));
}
} else {
return null;
}
...
var handler = cljs.core.get.call(null,map__41234__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var route_params = cljs.core.get.call(null,map__41234__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055));
...
power_turtle.view.navigation.history = (function (){var G__41236 = (new goog.History());
goog.events.removeAll(G__41236);

goog.events.listen(G__41236,goog.history.EventType.NAVIGATE,((function (G__41236){
...
G__41236.setEnabled(true);

return G__41236;
})();
}

//# sourceMappingURL=navigation.js.map?rel=1509738681571
