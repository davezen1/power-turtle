...
return (function power_turtle$view$lesson$lesson_view_$_a_lesson_view(p__39753){
...
var id = cljs.core.get.call(null,map__39754__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
goog.net.XhrIo.send(id,((function (map__39754,map__39754__$1,id,current_id,slides,slide_index){
return (function (e){
...
});})(map__39754,map__39754__$1,id,current_id,slides,slide_index))
);
}
} else {
}
...
//# sourceMappingURL=lesson.js.map?rel=1509738668088
