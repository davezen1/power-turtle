...
while (G__35387__i < G__35387__a.length) {G__35387__a[G__35387__i] = arguments[G__35387__i + 0]; ++G__35387__i;}
  args = new cljs.core.IndexedSeq(G__35387__a,0,null);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__35388){
var args = cljs.core.seq(arglist__35388);
...
return cljs.core.get_in.call(null,new_db,p1__35389_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__35390_SHARP_){
return cljs.core.get_in.call(null,db,p1__35390_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__35391__i = 0, G__35391__a = new Array(arguments.length -  2);
while (G__35391__i < G__35391__a.length) {G__35391__a[G__35391__i] = arguments[G__35391__i + 2]; ++G__35391__i;}
  in_paths = new cljs.core.IndexedSeq(G__35391__a,0,null);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__35392){
var f = cljs.core.first(arglist__35392);
arglist__35392 = cljs.core.next(arglist__35392);
var out_path = cljs.core.first(arglist__35392);
var in_paths = cljs.core.rest(arglist__35392);
...
//# sourceMappingURL=middleware.js.map?rel=1509738655743
