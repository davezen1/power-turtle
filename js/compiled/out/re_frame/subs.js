...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4657__auto___35353 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__35348_SHARP_){
if(!((p1__35348_SHARP_ == null))){
if((false) || ((cljs.core.PROTOCOL_SENTINEL === p1__35348_SHARP_.reagent$ratom$IReactiveAtom$))){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4657__auto___35353){
var not_reactive_35354 = temp__4657__auto___35353;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_35354);
} else {
}
} else {
}
...
//# sourceMappingURL=subs.js.map?rel=1509738655616
