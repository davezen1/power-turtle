...
var o46394 = temp__4655__auto__;
var temp__4655__auto____$1 = (o46394["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o46395 = temp__4655__auto____$1;
return (o46395["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__45499__auto__ = f;
return (o__45499__auto__["toString"]).call(o__45499__auto__);
} else {
return "";
}
}catch (e46396){var _ = e46396;
return "";
}});
...
try{var o__45499__auto___46398 = t;
(o__45499__auto___46398["cljs$lang$ctorPrWriter"]).call(o__45499__auto___46398,t,writer);
}catch (e46397){var __46399 = e46397;
}
...
var char_code = (function (){var o__45499__auto__ = (new String(char$));
return (o__45499__auto__["charCodeAt"]).call(o__45499__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__45499__auto__ = String;
return (o__45499__auto__["fromCharCode"]).call(o__45499__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__46400 = num_code;
switch (G__46400) {
case (1):
return (185);
...
var o__45499__auto__ = String;
return (o__45499__auto__["fromCharCode"]).call(o__45499__auto__,superscript_code);
});
/**
...
}catch (e46402){var _e__45506__auto__ = e46402;
return false;
}})())){
...
var vec__46403 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__46403,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o46406 = temp__4655__auto__;
var temp__4655__auto____$1 = (o46406["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o46407 = temp__4655__auto____$1;
return (o46407["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29308__auto___46414 = arguments.length;
var i__29309__auto___46415 = (0);
while(true){
if((i__29309__auto___46415 < len__29308__auto___46414)){
args__29315__auto__.push((arguments[i__29309__auto___46415]));

var G__46416 = (i__29309__auto___46415 + (1));
i__29309__auto___46415 = G__46416;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__46410){
var vec__46411 = p__46410;
var ns_detector = cljs.core.nth.call(null,vec__46411,(0),null);
...
var G__46417 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__46418 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__46417;
remaining_tokens = G__46418;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq46408){
var G__46409 = cljs.core.first.call(null,seq46408);
var seq46408__$1 = cljs.core.next.call(null,seq46408);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__46409,seq46408__$1);
});
...
var vec__46422 = cljs.core.split_with.call(null,(function (p1__46421_SHARP_){
return cljs.core.not_EQ_.call(null,p1__46421_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__46422,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__46422,(1),null);
...
var vec__46425 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__46425,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__46425,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__46428 = cljs.core.rest.call(null,remaining_tokens);
var G__46429 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__46428;
name_tokens = G__46429;
continue;
} else {
...
var vec__46432 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__46432,(0),null);
var arity = cljs.core.nth.call(null,vec__46432,(1),null);
var vec__46435 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__46435,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__46435,(1),null);
var vec__46438 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__46438,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__46438,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__46438,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__46438,(3),null);
...
var vec__46444 = result;
var munged_ns = cljs.core.nth.call(null,vec__46444,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__46444,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__46444,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__46444,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__46444,(4),null);
var arity = cljs.core.nth.call(null,vec__46444,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__46448 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__46448,(0),null);
var args = cljs.core.nth.call(null,vec__46448,(1),null);
var vec__46451 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__46451,(0),null);
var name = cljs.core.nth.call(null,vec__46451,(1),null);
...
var G__46454 = (arity + (1));
var G__46455 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__46456){
var vec__46457 = p__46456;
var arity = cljs.core.nth.call(null,vec__46457,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__46457,(1),null);
...
return cljs.core.get.call(null,arities,p1__46460_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__46461_SHARP_);
...
var args__29315__auto__ = [];
var len__29308__auto___46468 = arguments.length;
var i__29309__auto___46469 = (0);
while(true){
if((i__29309__auto___46469 < len__29308__auto___46468)){
args__29315__auto__.push((arguments[i__29309__auto___46469]));

var G__46470 = (i__29309__auto___46469 + (1));
i__29309__auto___46469 = G__46470;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__46464){
var vec__46465 = p__46464;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__46465,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq46462){
var G__46463 = cljs.core.first.call(null,seq46462);
var seq46462__$1 = cljs.core.next.call(null,seq46462);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__46463,seq46462__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__46473__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__46473__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__46473__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__46473__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__46474 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__46474,(0),null);
var fn_name = cljs.core.nth.call(null,vec__46474,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__46474,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__46474,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__46474,(4),null);
var arity = cljs.core.nth.call(null,vec__46474,(5),null);
...
var o__45499__auto__ = f;
return (o__45499__auto__["getBasis"]).call(o__45499__auto__);
});
/**
...
}catch (e46478){var _e__45506__auto__ = e46478;
...
var G__46479 = (obj[cljs.core.first.call(null,path)]);
var G__46480 = cljs.core.rest.call(null,path);
obj = G__46479;
path = G__46480;
continue;
} else {
...
return (function (accum,p__46481){
var vec__46482 = p__46481;
var bit = cljs.core.nth.call(null,vec__46482,(0),null);
var protocol = cljs.core.nth.call(null,vec__46482,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__46485){
...
var selector = cljs.core.nth.call(null,vec__46486,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__46491,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__46491,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__46491,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__46489_SHARP_){
return (obj[cljs.core.first.call(null,p1__46489_SHARP_)]);
});})(name,sorted_matches,vec__46491,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1509738685037
