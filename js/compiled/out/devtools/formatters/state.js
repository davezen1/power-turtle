...
var len__29308__auto___46516 = arguments.length;
var i__29309__auto___46517 = (0);
while(true){
if((i__29309__auto___46517 < len__29308__auto___46516)){
args__29315__auto__.push((arguments[i__29309__auto___46517]));

var G__46518 = (i__29309__auto___46517 + (1));
i__29309__auto___46517 = G__46518;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq46514){
var G__46515 = cljs.core.first.call(null,seq46514);
var seq46514__$1 = cljs.core.next.call(null,seq46514);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__46515,seq46514__$1);
});
...
return (p1__46519_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1509738685138
