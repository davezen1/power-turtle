...
var start_line = cljs.core.get.call(null,map__38274__$1,new cljs.core.Keyword(null,"start-line","start-line",-41746654));
var end_line = cljs.core.get.call(null,map__38274__$1,new cljs.core.Keyword(null,"end-line","end-line",1837326455));
var num_new_lines = cljs.core.get.call(null,map__38274__$1,new cljs.core.Keyword(null,"num-new-lines","num-new-lines",-1319642646));
var lines = (function (){var iter__28947__auto__ = ((function (map__38274,map__38274__$1,start_line,end_line,num_new_lines){
return (function re_console$parinfer$compute_cm_change_$_iter__38276(s__38277){
return (new cljs.core.LazySeq(null,((function (map__38274,map__38274__$1,start_line,end_line,num_new_lines){
return (function (){
...
var c__28945__auto__ = cljs.core.chunk_first.call(null,s__38277__$2);
var size__28946__auto__ = cljs.core.count.call(null,c__28945__auto__);
var b__38279 = cljs.core.chunk_buffer.call(null,size__28946__auto__);
if((function (){var i__38278 = (0);
while(true){
if((i__38278 < size__28946__auto__)){
var i = cljs.core._nth.call(null,c__28945__auto__,i__38278);
cljs.core.chunk_append.call(null,b__38279,cm.getLine(i));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38279),re_console$parinfer$compute_cm_change_$_iter__38276.call(null,cljs.core.chunk_rest.call(null,s__38277__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38279),null);
}
} else {
var i = cljs.core.first.call(null,s__38277__$2);
return cljs.core.cons.call(null,cm.getLine(i),re_console$parinfer$compute_cm_change_$_iter__38276.call(null,cljs.core.rest.call(null,s__38277__$2)));
}
} else {
return null;
}
...
});})(map__38274,map__38274__$1,start_line,end_line,num_new_lines))
,null,null));
});})(map__38274,map__38274__$1,start_line,end_line,num_new_lines))
;
...
return (function() { 
var G__38285__delegate = function (p__38281){
var map__38282 = p__38281;
var map__38282__$1 = ((((!((map__38282 == null)))?((((map__38282.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38282.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38282):map__38282);
var change = cljs.core.get.call(null,map__38282__$1,new cljs.core.Keyword(null,"change","change",-1163046502),null);
var use_cache_QMARK_ = cljs.core.get.call(null,map__38282__$1,new cljs.core.Keyword(null,"use-cache?","use-cache?",-81331778),false);
...
var new_text = (function (){var G__38284 = cljs.core.deref.call(null,mode);
...
while (G__38287__i < G__38287__a.length) {G__38287__a[G__38287__i] = arguments[G__38287__i + 0]; ++G__38287__i;}
  p__38281 = new cljs.core.IndexedSeq(G__38287__a,0,null);
} 
return G__38285__delegate.call(this,p__38281);};
G__38285.cljs$lang$maxFixedArity = 0;
G__38285.cljs$lang$applyTo = (function (arglist__38288){
var p__38281 = cljs.core.seq(arglist__38288);
return G__38285__delegate(p__38281);
});
...
//# sourceMappingURL=parinfer.js.map?rel=1509738665393
