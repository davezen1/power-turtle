...
return new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"add-input","add-input",-994386222),(function (p1__38291_SHARP_,p2__38292_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-console-input","add-console-input",-277003986),console_key,p1__38291_SHARP_,p2__38292_SHARP_], null));
}),new cljs.core.Keyword(null,"add-result","add-result",1382794315),(function (p1__38293_SHARP_,p2__38294_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-console-result","add-console-result",1768771531),console_key,p1__38293_SHARP_,p2__38294_SHARP_], null));
}),new cljs.core.Keyword(null,"go-up","go-up",-783282342),(function (p1__38295_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"console-go-up","console-go-up",50535611),console_key,p1__38295_SHARP_], null));
}),new cljs.core.Keyword(null,"go-down","go-down",-1002511595),(function (p1__38296_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"console-go-down","console-go-down",-1045916631),console_key,p1__38296_SHARP_], null));
}),new cljs.core.Keyword(null,"clear-items","clear-items",524826180),(function (p1__38297_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"clear-console-items","clear-console-items",-1821518386),console_key,p1__38297_SHARP_], null));
}),new cljs.core.Keyword(null,"set-text","set-text",1346789745),(function (p1__38298_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"console-set-text","console-set-text",860354388),console_key,p1__38298_SHARP_], null));
}),new cljs.core.Keyword(null,"add-log","add-log",1433037691),(function (p1__38299_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-console-log","add-console-log",-371208070),console_key,p1__38299_SHARP_], null));
})], null);
});
...
re_console.editor.on_change = (function re_console$editor$on_change(inst,console_key,text,p__38300,mode){
...
var set_text = cljs.core.get.call(null,map__38301__$1,new cljs.core.Keyword(null,"set-text","set-text",1346789745));
...
return ((function (on_after_change,on_before_change,map__38301,map__38301__$1,set_text){
...
;})(on_after_change,on_before_change,map__38301,map__38301__$1,set_text))
});
re_console.editor.on_keydown = (function re_console$editor$on_keydown(console_key,p__38304,eval_opts){
...
var should_go_up = cljs.core.get.call(null,map__38305__$1,new cljs.core.Keyword(null,"should-go-up","should-go-up",2137977547));
var should_go_down = cljs.core.get.call(null,map__38305__$1,new cljs.core.Keyword(null,"should-go-down","should-go-down",473755082));
var go_up = cljs.core.get.call(null,map__38305__$1,new cljs.core.Keyword(null,"go-up","go-up",-783282342));
var go_down = cljs.core.get.call(null,map__38305__$1,new cljs.core.Keyword(null,"go-down","go-down",-1002511595));
return ((function (map__38305,map__38305__$1,should_go_up,should_go_down,go_up,go_down){
return (function (inst,evt){
if(cljs.core.truth_(re_console.editor.modifying_prompt_QMARK_.call(null,inst,evt.keyCode))){
return evt.preventDefault();
} else {
var G__38307 = evt.keyCode;
switch (G__38307) {
case (13):
...
return new cljs.core.Keyword(null,"evaluate","evaluate",1525218437).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,eval_opts)).call(null,((function (source,G__38307,map__38305,map__38305__$1,should_go_up,should_go_down,go_up,go_down){
return (function (p1__38303_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-eval-complete","on-eval-complete",436163213),console_key,p1__38303_SHARP_], null));
});})(source,G__38307,map__38305,map__38305__$1,should_go_up,should_go_down,go_up,go_down))
,source);
} else {
return null;
}
...
;})(map__38305,map__38305__$1,should_go_up,should_go_down,go_up,go_down))
});
...
var G__38309 = cljs.core.rest.call(null,exclude_chars);
exclude_chars = G__38309;
continue;
} else {
return char_index;
}
...
//# sourceMappingURL=editor.js.map?rel=1509738665459
