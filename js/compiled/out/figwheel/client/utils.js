...
return (new CustomEvent(event_name,(function (){var obj44121 = {"detail":data};
return obj44121;
})()));
} else {
...
var f = (function (){var pred__44128 = cljs.core._EQ_;
var expr__44129 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44128.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44129))){
return ((function (pred__44128,expr__44129){
return (function (p1__44122_SHARP_){
return console.warn(p1__44122_SHARP_);
});
;})(pred__44128,expr__44129))
} else {
if(cljs.core.truth_(pred__44128.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44129))){
return ((function (pred__44128,expr__44129){
return (function (p1__44123_SHARP_){
return console.debug(p1__44123_SHARP_);
});
;})(pred__44128,expr__44129))
} else {
if(cljs.core.truth_(pred__44128.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44129))){
return ((function (pred__44128,expr__44129){
return (function (p1__44124_SHARP_){
return console.error(p1__44124_SHARP_);
});
;})(pred__44128,expr__44129))
} else {
return ((function (pred__44128,expr__44129){
return (function (p1__44125_SHARP_){
return console.log(p1__44125_SHARP_);
});
;})(pred__44128,expr__44129))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44132){
var map__44133 = p__44132;
var map__44133__$1 = ((((!((map__44133 == null)))?((((map__44133.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44133.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44133):map__44133);
var opts = map__44133__$1;
var eval_fn = cljs.core.get.call(null,map__44133__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__44135_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__44137,(0),null);
var v = cljs.core.nth.call(null,vec__44137,(1),null);
...
}catch (e44142){if((e44142 instanceof Error)){
var e = e44142;
return not_found;
} else {
throw e44142;
...
//# sourceMappingURL=utils.js.map?rel=1509738683240
